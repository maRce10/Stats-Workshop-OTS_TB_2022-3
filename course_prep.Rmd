...
1) Install R on the computer you will use during the course (https://cran.r-project.org/). I assume that you already have it installed, but try to update it if you have a R version < 4.0.0. You can find which R version you have by running this in the R console:
